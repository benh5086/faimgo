export default function Home() {
  ...
  const C = {
    white: '#FFFFFF',
    tint: '#F1F4F2',      // subtle section background
    line: '#E4E8E5',      // hairline borders
    green: '#1B3A2D',     // brand anchor
    greenDeep: '#14241B', // footer / deepest
    ink: '#15181B',       // headings / high-contrast text
    body: '#464C54',      // readable body text
    gold: '#8A6A14',      // readable accent on light
    goldBright: '#D2A54A',// accent on dark backgrounds
    ...
    <main className="min-h-screen font-sans" style={{backgroundColor: C.white, color: C.ink}}>
      ...
      <nav style={{backgroundColor: C.green}} className="px-8 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a href="/assessment" className="px-5 py-2.5 rounded-full text-[15px] font-semibold transition-all hover:opacity-90"
      ...
      <section className="px-8 py-24 max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-16">
        <div className="flex-1">
          <a href="/assessment" className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-[14px] font-semibold mb-7 transition-all hover:opacity-80"
            style={{backgroundColor: C.tint, color: C.green, border: `1px solid ${C.line}`}}>
            Free 2-minute assessment →
          </a>
          <h1 className="font-display text-5xl md:text-6xl leading-[1.08] mb-6" style={{color: C.green}}>
            Find, Aim, and <span style={{color: C.gold}}>Grow</span> Your Side Income
          </h1>
          <p className="text-xl leading-relaxed mb-9" style={{color: C.body}}>
          ...
          <div className="flex flex-wrap gap-4">
            <a href="/assessment" className="px-8 py-4 rounded-full font-semibold text-[17px] transition-all hover:opacity-90"
              style={{backgroundColor: C.green, color: C.white}}>
              Start My Assessment
            </a>
            <a href="#how-it-works" className="px-8 py-4 rounded-full font-semibold text-[17px] border-2 transition-all hover:bg-black/[0.03]"
        ...
        <div className="flex-1 w-full rounded-2xl p-8" style={{backgroundColor: C.tint, border: `1px solid ${C.line}`}}>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              <div key={i} className="p-8 rounded-2xl" style={{backgroundColor: C.white, border: `1px solid ${C.line}`}}>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="p-7 rounded-2xl" style={{backgroundColor: C.white, border: `1px solid ${C.line}`}}>
      ...
      <section id="faq" className="px-8 py-24 max-w-4xl mx-auto">
        ...
        <div className="flex flex-col gap-5">
          {[
            ...
            <div key={i} className="p-7 rounded-2xl" style={{backgroundColor: C.tint, border: `1px solid ${C.line}`}}>
      ...
      <section id="start" className="px-8 py-28 text-center" style={{backgroundColor: C.green}}>
        ...
        <div className="flex flex-wrap gap-4 justify-center">
          <a href="/assessment" className="px-10 py-4 rounded-full font-semibold text-[17px] transition-all hover:opacity-90"
            style={{backgroundColor: C.goldBright, color: C.green}}>
            Start Free Assessment
          </a>
          <a href="#how-it-works" className="px-10 py-4 rounded-full font-semibold text-[17px] border-2 transition-all hover:bg-white/10"
